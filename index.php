        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link mx-2 fw-bold text-primary" href="blogs.php">Blogs</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p class="text-muted small">Subscribe to our newsletter for the latest career tips.</p>
