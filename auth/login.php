...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($u && password_verify($pass, $u['password'])) {
        ...
        $redirect = ($u['role'] === 'admin') ? "../hiddenadminpanelofcv/index.php" : "../dashboard/index.php";
...
<head>
    ...
    <style>
        body { background-color: var(--bg-color); height: 100vh; display: flex; align-items: center; justify-content: center; }
        .auth-card { width: 100%; max-width: 400px; padding: 2.5rem; border-radius: 0.5rem; background: #fff; box-shadow: 0 0.15rem 1.75rem 0 rgba(58, 59, 69, 0.15); }
        .logo { color: var(--primary-color); font-size: 1.5rem; font-weight: 700; text-decoration: none; display: block; text-align: center; margin-bottom: 1.5rem; }
    </style>
</head>
<body>
    <div class="auth-card">
        <a href="../index.php" class="logo"><i class="fas fa-robot me-2"></i>CV Analyzer</a>
